...
//
//public class NimbusCopy implements Iface, Shutdownable, DaemonCommon {
//    @VisibleForTesting
...
//    private static final Logger LOG = LoggerFactory.getLogger(NimbusCopy.class);
//    //    Metrics
...
//    private static final TopologyStateTransition INACTIVE_TRANSITION = (arg, nimbus, topoId, base) -> NimbusCopy.make(TopologyStatus.INACTIVE);
//    private static final TopologyStateTransition ACTIVE_TRANSITION = (arg, nimbus, topoId, base) -> NimbusCopy.make(TopologyStatus.ACTIVE);
...
//        return NimbusCopy.make(base.get_prev_status());
//    };
...
//        } else {
//            delay = ObjectReader.getInt(NimbusCopy.readTopoConf(topoId, nimbus.getTopoCache()).get(Config.TOPOLOGY_MESSAGE_TIMEOUT_SECS));
//        }
...
//
//    public NimbusCopy(Map<String, Object> conf, INimbus inimbus, StormMetricsRegistry metricsRegistry) throws Exception {
//        this(conf, inimbus, null, null, null, null, null, metricsRegistry);
//    }
//
//    public NimbusCopy(Map<String, Object> conf, INimbus inimbus, IStormClusterState stormClusterState, NimbusInfo hostPortInfo,
...
//    }
//
//    private static ClusterInfo mkClusterInfo() {
...
//    }
//
//    private static NimbusCopy launchServer(Map<String, Object> conf, INimbus inimbus) throws Exception {
//        StormCommon.validateDistributedMode(conf);
//        validatePortAvailable(conf);
//        StormMetricsRegistry metricsRegistry = new StormMetricsRegistry();
//        final NimbusCopy nimbus = new NimbusCopy(conf, inimbus, metricsRegistry);
//        nimbus.launchServer();
...
//    }
//
//    public static NimbusCopy launch(INimbus inimbus) throws Exception {
...
//        for (Entry<String, Assignment> assignmentEntry : stormClusterState.assignmentsInfo().entrySet()) {
